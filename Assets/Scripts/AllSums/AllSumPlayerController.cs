...
public class AllSumPlayerController : MonoBehaviour
{
    ...
    private AllSumsGameManager _gameManager;
    ...
    {
        movesCount = 0;
        _gameManager = GameObject.Find("GameManager").GetComponent<AllSumsGameManager>();
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hitInfo))
            {
                ...
                else if (_numberSelected != null && hitInfo.transform.tag == "Number")
                {
                    ...
                    NumbersAllSums num1 = _numberSelected.GetComponent<NumbersAllSums>();
                    NumbersAllSums num2 = _numberReplace.GetComponent<NumbersAllSums>();
                    int auxRow = num1.row;
                    int auxCol = num1.col;
